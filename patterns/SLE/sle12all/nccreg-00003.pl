...
SDP::Core::processOptions();
	if ( checkSuseRegister() ) {
		SDP::Core::updateStatus(STATUS_CRITICAL, "Invalid NCC Registration Protocol, Use HTTPS only.");
	} else {
		SDP::Core::updateStatus(STATUS_ERROR, "Valid NCC Registration Protocol");
	}
