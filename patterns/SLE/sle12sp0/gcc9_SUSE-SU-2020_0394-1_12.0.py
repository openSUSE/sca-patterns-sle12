...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 0 ):
		PACKAGES = {
			'cpp9': '9.2.1+r275327-1.3.9',
			'cpp9-debuginfo': '9.2.1+r275327-1.3.9',
			'gcc9': '9.2.1+r275327-1.3.9',
			'gcc9-32bit': '9.2.1+r275327-1.3.9',
			'gcc9-ada': '9.2.1+r275327-1.3.9',
			'gcc9-ada-32bit': '9.2.1+r275327-1.3.9',
			...
			'gcc9-fortran': '9.2.1+r275327-1.3.9',
			...
			'gcc9-info': '9.2.1+r275327-1.3.9',
			'gcc9-locale': '9.2.1+r275327-1.3.9',
			'libada9': '9.2.1+r275327-1.3.9',
			'libada9-32bit': '9.2.1+r275327-1.3.9',
			'libada9-32bit-debuginfo': '9.2.1+r275327-1.3.9',
			...
			'libgcc_s1-32bit-debuginfo': '9.2.1+r275327-1.3.9',
			...
			'libitm1-32bit-debuginfo': '9.2.1+r275327-1.3.9',
