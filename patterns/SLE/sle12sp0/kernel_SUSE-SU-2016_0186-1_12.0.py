#!/usr/bin/python
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2016:0186-1
...
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2016-01/msg00021.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 0 ):
		PACKAGES = {
			...
			'kernel-default-base-debuginfo': '3.12.51-60.25.1',
			'kernel-default-debuginfo': '3.12.51-60.25.1',
			'kernel-default-debugsource': '3.12.51-60.25.1',
			'kernel-default-devel': '3.12.51-60.25.1',
			'kernel-default-extra': '3.12.51-60.25.1',
			'kernel-default-extra-debuginfo': '3.12.51-60.25.1',
			'kernel-default-man': '3.12.51-60.25.1',
			'kernel-devel': '3.12.51-60.25.1',
			'kernel-docs': '3.12.51-60.25.2',
			'kernel-ec2': '3.12.51-60.25.1',
			'kernel-ec2-debuginfo': '3.12.51-60.25.1',
			'kernel-ec2-debugsource': '3.12.51-60.25.1',
			'kernel-ec2-devel': '3.12.51-60.25.1',
			'kernel-ec2-extra': '3.12.51-60.25.1',
			'kernel-ec2-extra-debuginfo': '3.12.51-60.25.1',
			'kernel-macros': '3.12.51-60.25.1',
			'kernel-obs-build': '3.12.51-60.25.1',
			'kernel-obs-build-debugsource': '3.12.51-60.25.1',
			'kernel-source': '3.12.51-60.25.1',
			'kernel-syms': '3.12.51-60.25.1',
			'kernel-xen': '3.12.51-60.25.1',
			'kernel-xen-base': '3.12.51-60.25.1',
			'kernel-xen-base-debuginfo': '3.12.51-60.25.1',
			'kernel-xen-debuginfo': '3.12.51-60.25.1',
			'kernel-xen-debugsource': '3.12.51-60.25.1',
