...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 0 ):
		PACKAGES = {
			...
			'kernel-ec2': '3.12.61-52.80.1',
			'kernel-ec2-debuginfo': '3.12.61-52.80.1',
			'kernel-ec2-debugsource': '3.12.61-52.80.1',
			'kernel-ec2-devel': '3.12.61-52.80.1',
			'kernel-ec2-extra': '3.12.61-52.80.1',
			'kernel-ec2-extra-debuginfo': '3.12.61-52.80.1',
