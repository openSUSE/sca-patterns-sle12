...
OTHER_LINKS = "META_LINK_Note=https://www.suse.com/releasenotes/x86_64/SUSE-SLES/12/#Intro.Support.Techpreviews|META_LINK_Support=https://www.suse.com/releasenotes/x86_64/SUSE-SLES/12/#fate-316271|META_LINK_Fate=https://fate.suse.com/316271"
...
if "s390x" in SERVER['Architecture'].lower():
	if( SUSE.packageInstalled(PACKAGE) ):
		Core.updateStatus(Core.WARN, "KVM on s390x is unsupported technology preview software")
	else:
