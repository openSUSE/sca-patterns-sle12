#!/usr/bin/python3
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2017:2459-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.opensuse.org/opensuse-security-announce/2017-09/msg00043.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 1 ):
		PACKAGES = {
			...
			'kernel-default-base-debuginfo': '3.12.74-60.64.60.1',
			'kernel-default-debuginfo': '3.12.74-60.64.60.1',
			'kernel-default-debugsource': '3.12.74-60.64.60.1',
			...
			'kernel-xen-base-debuginfo': '3.12.74-60.64.60.1',
			'kernel-xen-debuginfo': '3.12.74-60.64.60.1',
			'kernel-xen-debugsource': '3.12.74-60.64.60.1',
