#!/usr/bin/python3
#
# Title:       Important Security Announcement for openssh SUSE-SU-2023:2940-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-July/015606.html"
	...
	if ( server['DistroVersion'] == 12):
		if ( server['DistroPatchLevel'] == 2 ):
			packages = {
				...
				'openssh-askpass-gnome-debuginfo': '7.2p2-74.63.1',
				'openssh-debuginfo': '7.2p2-74.63.1',
				'openssh-debugsource': '7.2p2-74.63.1',
				'openssh-fips': '7.2p2-74.63.1',
				'openssh-helpers': '7.2p2-74.63.1',
				'openssh-helpers-debuginfo': '7.2p2-74.63.1',
			}
