#!/usr/bin/python
#
# Title:       Important Security Announcement for qemu SUSE-SU-2018:0036-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.opensuse.org/opensuse-security-announce/2018-01/msg00021.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 2 ):
		PACKAGES = {
			...
			'qemu-arm-debuginfo': '2.6.2-41.31.1',
			...
			'qemu-ppc-debuginfo': '2.6.2-41.31.1',
			'qemu-s390': '2.6.2-41.31.1',
			'qemu-s390-debuginfo': '2.6.2-41.31.1',
