#!/usr/bin/python3
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2021:0452-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2021-February/008323.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 3 ):
		PACKAGES = {
			...
			'kernel-default-base-debuginfo': '4.4.180-94.138.1',
			'kernel-default-debuginfo': '4.4.180-94.138.1',
			'kernel-default-debugsource': '4.4.180-94.138.1',
			...
			'kgraft-patch-4_4_180-94_138-default-debuginfo': '1-4.3.1',
		}
