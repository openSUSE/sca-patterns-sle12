#!/usr/bin/python3
#
# Title:       Important Security Announcement for ceph SUSE-SU-2020:1158-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2020-April/006768.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			...
			'librados-devel-debuginfo': '12.2.12+git.1587570958.35d78d0243-2.45.1',
			...
			'python-rados-debuginfo': '12.2.12+git.1587570958.35d78d0243-2.45.1',
