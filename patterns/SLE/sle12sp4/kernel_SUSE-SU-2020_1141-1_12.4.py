#!/usr/bin/python
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2020:1141-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2020-April/006755.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 4 ):
		PACKAGES = {
			...
			'cluster-md-kmp-default-debuginfo': '4.12.14-95.51.1',
			'dlm-kmp-default': '4.12.14-95.51.1',
			'dlm-kmp-default-debuginfo': '4.12.14-95.51.1',
			'gfs2-kmp-default': '4.12.14-95.51.1',
			'gfs2-kmp-default-debuginfo': '4.12.14-95.51.1',
			'kernel-default': '4.12.14-95.51.1',
			'kernel-default-base': '4.12.14-95.51.1',
			'kernel-default-base-debuginfo': '4.12.14-95.51.1',
			'kernel-default-debuginfo': '4.12.14-95.51.1',
			'kernel-default-debugsource': '4.12.14-95.51.1',
			'kernel-default-devel': '4.12.14-95.51.1',
			'kernel-default-devel-debuginfo': '4.12.14-95.51.1',
			'kernel-default-extra': '4.12.14-95.51.1',
			'kernel-default-extra-debuginfo': '4.12.14-95.51.1',
			...
			'kernel-obs-build-debugsource': '4.12.14-95.51.1',
			...
			'ocfs2-kmp-default-debuginfo': '4.12.14-95.51.1',
		}
