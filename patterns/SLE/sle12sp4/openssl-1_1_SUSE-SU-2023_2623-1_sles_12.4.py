#!/usr/bin/python3
#
# Title:       Moderate Security Announcement for openssl-1_1 SUSE-SU-2023:2623-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-June/015285.html"
	...
	if ( server['DistroVersion'] == 12):
		if ( server['DistroPatchLevel'] == 4 ):
			packages = {
				...
				'libopenssl1_1-debuginfo': '1.1.1d-2.89.1',
				'libopenssl1_1-hmac': '1.1.1d-2.89.1',
				'openssl-1_1': '1.1.1d-2.89.1',
				'openssl-1_1-debuginfo': '1.1.1d-2.89.1',
				'openssl-1_1-debugsource': '1.1.1d-2.89.1',
			}
