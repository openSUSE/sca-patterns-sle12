#!/usr/bin/python3
#
# Title:       Important Security Announcement for clamav SUSE-SU-2023:3435-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-August/016023.html"
	...
	if ( server['DistroVersion'] == 12):
		if ( server['DistroPatchLevel'] == 5 ):
			packages = {
				...
				'clamav-debuginfo': '0.103.9-3.27.1',
				'clamav-debugsource': '0.103.9-3.27.1',
			}
