#!/usr/bin/python3
#
# Title:       Moderate Security Announcement for git SUSE-SU-2022:4271-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2022-November/013141.html"
	...
	if ( server['DistroVersion'] == 12):
		if ( server['DistroPatchLevel'] == 5 ):
			packages = {
				...
				'git-core-debuginfo': '2.26.2-27.60.1',
				'git-cvs': '2.26.2-27.60.1',
				'git-daemon': '2.26.2-27.60.1',
				'git-daemon-debuginfo': '2.26.2-27.60.1',
				'git-debugsource': '2.26.2-27.60.1',
