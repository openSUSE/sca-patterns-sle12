#!/usr/bin/python3
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2020:1693-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2020-June/006990.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 5 ):
		PACKAGES = {
			...
			'kernel-default-kgraft': '4.12.14-122.26.1',
			'kernel-default-kgraft-devel': '4.12.14-122.26.1',
			...
			'kgraft-patch-4_12_14-122_26-default': '1-8.3.1',
