#!/usr/bin/python
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2021:0739-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2021-March/008449.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 5 ):
		PACKAGES = {
			...
			'kernel-azure-base-debuginfo': '4.12.14-16.47.1',
			'kernel-azure-debuginfo': '4.12.14-16.47.1',
			'kernel-azure-debugsource': '4.12.14-16.47.1',
