#!/usr/bin/python
#
# Title:       Important Security Announcement for Kernel SUSE-SU-2021:2407-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2021-July/009167.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 5 ):
		PACKAGES = {
			...
			'kernel-azure-base-debuginfo': '4.12.14-16.65.1',
			'kernel-azure-debuginfo': '4.12.14-16.65.1',
			'kernel-azure-debugsource': '4.12.14-16.65.1',
