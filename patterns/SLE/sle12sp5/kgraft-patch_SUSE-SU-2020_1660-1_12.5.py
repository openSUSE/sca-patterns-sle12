...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2020-June/006967.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 5 ):
		PACKAGES = {
			...
			'gnuplot-debuginfo': '4.6.5-3.3.74',
			'gnuplot-debugsource': '4.6.5-3.3.74',
		}
