...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 5 ):
		PACKAGES = {
			'libQt5Bootstrap-devel-static': '5.6.2-6.25.1',
			'libQt5Concurrent-devel': '5.6.2-6.25.1',
			'libQt5Concurrent5': '5.6.2-6.25.1',
			'libQt5Concurrent5-debuginfo': '5.6.2-6.25.1',
			'libQt5Core-devel': '5.6.2-6.25.1',
			'libQt5Core-private-headers-devel': '5.6.2-6.25.1',
			'libQt5Core5': '5.6.2-6.25.1',
			'libQt5Core5-debuginfo': '5.6.2-6.25.1',
			'libQt5DBus-devel': '5.6.2-6.25.1',
			'libQt5DBus-devel-debuginfo': '5.6.2-6.25.1',
			'libQt5DBus-private-headers-devel': '5.6.2-6.25.1',
			'libQt5DBus5': '5.6.2-6.25.1',
			'libQt5DBus5-debuginfo': '5.6.2-6.25.1',
			'libQt5Gui-devel': '5.6.2-6.25.1',
			'libQt5Gui-private-headers-devel': '5.6.2-6.25.1',
			'libQt5Gui5': '5.6.2-6.25.1',
			'libQt5Gui5-debuginfo': '5.6.2-6.25.1',
			'libQt5Network-devel': '5.6.2-6.25.1',
			'libQt5Network-private-headers-devel': '5.6.2-6.25.1',
			'libQt5Network5': '5.6.2-6.25.1',
			'libQt5Network5-debuginfo': '5.6.2-6.25.1',
			'libQt5OpenGL-devel': '5.6.2-6.25.1',
			'libQt5OpenGL-private-headers-devel': '5.6.2-6.25.1',
			'libQt5OpenGL5': '5.6.2-6.25.1',
			'libQt5OpenGL5-debuginfo': '5.6.2-6.25.1',
			'libQt5OpenGLExtensions-devel-static': '5.6.2-6.25.1',
			'libQt5PlatformHeaders-devel': '5.6.2-6.25.1',
			'libQt5PlatformSupport-devel-static': '5.6.2-6.25.1',
			'libQt5PlatformSupport-private-headers-devel': '5.6.2-6.25.1',
			'libQt5PrintSupport-devel': '5.6.2-6.25.1',
			'libQt5PrintSupport-private-headers-devel': '5.6.2-6.25.1',
			'libQt5PrintSupport5': '5.6.2-6.25.1',
			'libQt5PrintSupport5-debuginfo': '5.6.2-6.25.1',
			'libQt5Sql-devel': '5.6.2-6.25.1',
			'libQt5Sql-private-headers-devel': '5.6.2-6.25.1',
			...
			'libQt5Test-devel': '5.6.2-6.25.1',
			'libQt5Test-private-headers-devel': '5.6.2-6.25.1',
			'libQt5Test5': '5.6.2-6.25.1',
			'libQt5Test5-debuginfo': '5.6.2-6.25.1',
			'libQt5Widgets-devel': '5.6.2-6.25.1',
			'libQt5Widgets-private-headers-devel': '5.6.2-6.25.1',
			'libQt5Widgets5': '5.6.2-6.25.1',
			'libQt5Widgets5-debuginfo': '5.6.2-6.25.1',
			'libQt5Xml-devel': '5.6.2-6.25.1',
			'libQt5Xml5': '5.6.2-6.25.1',
			'libQt5Xml5-debuginfo': '5.6.2-6.25.1',
			'libqt5-qtbase-common-devel': '5.6.2-6.25.1',
			'libqt5-qtbase-common-devel-debuginfo': '5.6.2-6.25.1',
			'libqt5-qtbase-debugsource': '5.6.2-6.25.1',
			'libqt5-qtbase-devel': '5.6.2-6.25.1',
			'libqt5-qtbase-private-headers-devel': '5.6.2-6.25.1',
		}
