...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 5 ):
		PACKAGES = {
			...
			'postgresql-server-devel': '12.0.1-4.4.1',
			...
			'postgresql10-devel': '10.14-4.4.1',
			'postgresql10-devel-debuginfo': '10.14-4.4.1',
			...
			'postgresql12': '12.4-3.5.1',
			'postgresql12-contrib': '12.4-3.5.1',
			'postgresql12-contrib-debuginfo': '12.4-3.5.1',
			'postgresql12-debuginfo': '12.4-3.5.1',
			'postgresql12-debugsource': '12.4-3.5.1',
			'postgresql12-devel': '12.4-3.5.1',
			'postgresql12-devel-debuginfo': '12.4-3.5.1',
			'postgresql12-docs': '12.4-3.5.1',
			'postgresql12-plperl': '12.4-3.5.1',
			'postgresql12-plperl-debuginfo': '12.4-3.5.1',
			'postgresql12-plpython': '12.4-3.5.1',
			'postgresql12-plpython-debuginfo': '12.4-3.5.1',
			'postgresql12-pltcl': '12.4-3.5.1',
			'postgresql12-pltcl-debuginfo': '12.4-3.5.1',
			'postgresql12-server': '12.4-3.5.1',
			'postgresql12-server-debuginfo': '12.4-3.5.1',
			'postgresql12-server-devel': '12.4-3.5.1',
			'postgresql12-server-devel-debuginfo': '12.4-3.5.1',
		}
