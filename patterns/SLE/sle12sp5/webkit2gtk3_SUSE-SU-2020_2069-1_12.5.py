#!/usr/bin/python3
#
# Title:       Important Security Announcement for webkit2gtk3 SUSE-SU-2020:2069-1
...
OTHER_LINKS = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2020-July/007191.html"
...
if ( SERVER['DistroVersion'] == 12):
	if ( SERVER['DistroPatchLevel'] == 5 ):
		PACKAGES = {
			...
			'libjavascriptcoregtk-4_0-18-debuginfo': '2.28.3-2.56.1',
			'libwebkit2gtk-4_0-37': '2.28.3-2.56.1',
			'libwebkit2gtk-4_0-37-debuginfo': '2.28.3-2.56.1',
			...
			'webkit2gtk-4_0-injected-bundles-debuginfo': '2.28.3-2.56.1',
			'webkit2gtk3-debugsource': '2.28.3-2.56.1',
