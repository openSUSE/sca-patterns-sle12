#!/usr/bin/python3
#
# Title:       Important Security Announcement for xen SUSE-SU-2023:3495-1
...
other_links = "META_LINK_Security=https://lists.suse.com/pipermail/sle-security-updates/2023-August/016050.html"
	...
	if ( server['DistroVersion'] == 12):
		if ( server['DistroPatchLevel'] == 5 ):
			packages = {
				...
				'xen-debugsource': '4.12.4_36-3.91.2',
				'xen-doc-html': '4.12.4_36-3.91.2',
				'xen-libs': '4.12.4_36-3.91.2',
				'xen-libs-32bit': '4.12.4_36-3.91.2',
				'xen-libs-debuginfo': '4.12.4_36-3.91.2',
				'xen-libs-debuginfo-32bit': '4.12.4_36-3.91.2',
				'xen-tools': '4.12.4_36-3.91.2',
				'xen-tools-debuginfo': '4.12.4_36-3.91.2',
				'xen-tools-domU': '4.12.4_36-3.91.2',
				'xen-tools-domU-debuginfo': '4.12.4_36-3.91.2',
			}
